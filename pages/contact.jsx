        ...
        <div className=" px-4 py-2">
            ...
            <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
              <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-LightGray md:text-sm">Myanmar</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="md:text-base">City:</span>
                  <span className="text-LightGray md:text-sm">Yangon</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="md:text-base">Company:</span>
                  <span className="text-LightGray md:text-sm">ITVisionHub</span>
                </div>
              </div>
              <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-LightGray text-sm">
                    winlaeyee269@gmail.com
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="md:text-base">Linkedin:</span>
                  <span className="text-LightGray text-sm">WinLaeYee</span>
                </div>
                <div className="flex justify-between items-center">
          ...
          <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
            <a
              ...
              href="mailto:winlaeyee269@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
              <HiMail />
            ...
            <a
              className="hover:scale-125 ease-in-out duration-700"
              href="https://github.com/WinLaeYee"
              target="_blank"
              rel="noreferrer"
            >
              <FaGithub />
            ...
            <a
              className="hover:scale-125 ease-in-out duration-700"
              href="http://linkedin.com/in/win-lae-yee-2040972b4"
              target="_blank"
              rel="noreferrer"
            >
              <FaLinkedin />
